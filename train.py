...
from loss import create_criterion, FocalLoss
import timm
...
def train(data_dir, model_dir, args):
    ...
    # model_module = timm.create_model('resnet50', pretrained=True)
    # model = model_module(
    #     num_classes=num_classes
    # ).to(device)
    model = timm.create_model('efficientnet_b3',pretrained=True).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--optimizer', type=str, default='SGDP', help='optimizer type (default: SGD)')
    parser.add_argument('--lr', type=float, default=1e-3, help='learning rate (default: 1e-3)')
    parser.add_argument('--val_ratio', type=float, default=0.2, help='ratio for validaton (default: 0.2)')
    parser.add_argument('--criterion', type=str, default='FocalLoss', help='criterion type (default: cross_entropy)')
